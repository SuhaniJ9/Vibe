...
const Layout = ({ children }) => {
  ...
  className="flex bg-[#E0FFFF] hover:border-[#1ca9c9] rounded-xl py-2 px-10 hover:scale-105 hover:bg-[#1ca9c9] font-semibold duration-300 space-x-2 focus:outline-none group"
>
  <LuLayoutDashboard className="text-xl text-blue-900 group-hover:text-white duration-300" />

  <span className="text-blue-900 group-hover:text-white duration-300">Dashboard</span>
</Link>
